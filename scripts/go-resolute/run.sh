...
# ============================================
DOCKER_USER="pepesan"
IMAGE_NAME="${DOCKER_USER}/mi-ubuntu-resolute-kasm-go"
IMAGE_TAG="1.0"
VNC_PASSWORD="sta3war2"
PORT=6911
CONTAINER_NAME="kasm-go-resolute-test"
# ============================================
...
echo -e "${YELLOW}=========================================${NC}"
echo -e "${YELLOW}   Lanzando contenedor Kasm Go (Resolute) ${NC}"
echo -e "${YELLOW}=========================================${NC}"
echo ""
...
if ! docker image inspect "${IMAGE_NAME}:${IMAGE_TAG}" &>/dev/null; then
  ...
  echo -e "${YELLOW}  Ejecuta primero: ./scripts/go-resolute/build.sh${NC}"
  exit 1
fi
